...
public class ApplicationController {
    ...
    public static AccountController accountController = new AccountController(); // Access AccountController
    public static AppointmentController appointmentController = new AppointmentController(); // Access AppointmentController
    ...
    public ApplicationController() {
        ...
        // Import account data from database
        ...
        System.out.println("Project Uniwa is Starting...");
    }
    ...
    public static void switchScreen(JPanel newScreen) {
        ...
        defaultScreen.getContentPane().revalidate();
